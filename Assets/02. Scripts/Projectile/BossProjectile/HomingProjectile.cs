...
public class HomingProjectile : BasePoolable
{
    ...
    public void Init(int damage, Vector3 position, Quaternion rotate, Transform target, float speed,HomingProjectileType type, float delayFireTime = 0f, float homingPower = 10f, float homingTime = 3f, float explosionSize = 0.5f, AnimationCurve homingCurve = null, AnimationCurve speedCurve = null)
    { 
