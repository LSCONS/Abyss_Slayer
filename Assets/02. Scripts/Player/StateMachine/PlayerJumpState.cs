...
public class PlayerJumpState : PlayerAirState
{
    ...
    protected void Jump()
    {
        ...
        var velocity = playerStateMachine.Player.PlayerRigidbody.linearVelocity;
        playerStateMachine.Player.PlayerRigidbody.linearVelocity = new Vector2(velocity.x, 0);
