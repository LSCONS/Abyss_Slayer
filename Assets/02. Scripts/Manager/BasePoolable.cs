...
public abstract class BasePoolable : MonoBehaviour
{
    ...
    public virtual void Init(Vector3 spawnPos, Vector2 size, float tickRate, float duration, float damage, LayerMask targetLayer)
    {

    }

    public virtual void Init(Vector3 spawnPos, Vector2 size, float tickRate, float duration, float damage, LayerMask targetLayer, string effetName)
    {
