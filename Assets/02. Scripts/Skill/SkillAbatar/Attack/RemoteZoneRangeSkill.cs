...
public class RemoteZoneRangeSkill : RangeAttackSkill
{
    ...
    public override void UseSkill()
    {
        base.UseSkill();
        // 풀에서 ZoneAOE 꺼내기
        MeleeDamageCheckData data = new MeleeDamageCheckData(player.PlayerRef, (int)slotKey, ColliderSize, ColliderOffset, TargetLayer.value, ColliderSetDelayTime, Damage, ColliderDuration, TickRate, (int)EEffectAnimatorController, (int)EHitEffectType.Normal, (int)EType.None);
